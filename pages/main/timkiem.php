...
$sql_pro = "SELECT * FROM tbl_sanpham,tbl_danhmuc  WHERE tbl_sanpham.id_danhmuc = tbl_danhmuc.id_danhmuc and tbl_sanpham.tensanpham LIke'%" .$tukhoa. "%'"; //sắp xếp sản phẩm
